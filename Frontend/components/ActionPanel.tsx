...
export const ActionPanel: React.FC<ActionPanelProps> = ({ onGenerate }) => {
  return (
    <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-full max-w-2xl px-6 z-40">
      <div className="bg-surface-dark/95 backdrop-blur-xl border border-white/10 rounded-2xl p-3 shadow-2xl shadow-black/50 flex items-center justify-between gap-6">
        ...
        <button
          onClick={onGenerate}
          className="group relative overflow-hidden bg-primary hover:bg-primary-hover active:scale-95 transition-all duration-200 rounded-xl px-8 py-3 flex items-center gap-3 shadow-glow"
        >
